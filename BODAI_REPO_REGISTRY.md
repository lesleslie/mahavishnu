...
## CLI surface summary (added 2026-08-29)

Generated by the 2026-08-25 CLI audit (see `docs/plans/2026-08-25-bodai-cli-audit-implementation.md`).
Refresh with `uv run python scripts/audit_cli_inventory.py all`; regress with `python3 scripts/diff_inventories.py`.

| Repo         | Entry point    | Command count | OneiricCLIBase adopted | `bodai.apps` registered |
|--------------|----------------|---------------|------------------------|-------------------------|
| mcp-common   | (library-only) | 0             | n/a                    | n/a                     |
| oneiric      | `oneiric`      | 30            | yes (canonical)        | yes                     |
| dhara        | `dhara`        | 15            | yes                    | yes                     |
| session-buddy| `session-buddy`| 16            | yes                    | yes                     |
| akosha       | `akosha`       | 9             | yes                    | yes                     |
| crackerjack  | `crackerjack`  | 32            | yes                    | yes                     |
| mahavishnu   | `mahavishnu`   | 159           | yes                    | yes (Plan Task 5.2)     |

**Total: 261 commands across the 6 CLI-bearing Core 7 repos** (mcp-common excluded as a library).
