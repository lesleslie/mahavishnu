...
## name: vishnu-status description: Check current Mahavishnu worker pool, verification, and dispatch status — equivalent to running pool list/health/metrics from a separate terminal.
