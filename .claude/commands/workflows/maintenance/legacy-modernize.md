...
1. **Data Validation During Migration:**
   ...
   def validate_migration(sample_size=10000):
       ...
       if not results['row_count_match']:
           logger.error(f"Row count mismatch: Legacy={legacy_count}, Modern={modern_count}")
       ...
       results['schema_compatible'] = validate_schema_compatibility(legacy_schema, modern_schema)
