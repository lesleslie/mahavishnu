...
| `bodai-cli-staleness-cadence.md` | Quarterly cadence for re-running `audit_cli_inventory.py all --check-stale`; launchd plist in mahavishnu's repo root, output to `docs/audit-inventory/staleness-<date>.log`. Established by the 2026-08-25 audit. | Active. |
