...
## name: python-pro description: >- Expert Python developer for modern Python 3.13+ with type safety and async. Ecosystem: mcp__crackerjack__crackerjack_run (pytest quality gates), mcp__akosha__search_code_patterns (cross-repo Python patterns), mcp__mahavishnu__pool_route_execute (distributed test execution). model: sonnet
