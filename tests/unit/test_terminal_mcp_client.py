...
class TestMcpretentiousClient:
    ...
    def test_default_construction_uses_tmux_backend(self) -> None:
        """The default ctor wires up the tmux backend (the only PTY builtin after
        the 2026-08-12 mcpretentious removal)."""
