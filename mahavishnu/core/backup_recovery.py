...
class BackupManager:
    ...
    def __init__(self, app):
        ...
        self.backup_schedule = getattr(app.config, 'backup_schedule', {
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                metadata = {
                    ...
                    "type": backup_type,
                    "version": "1.0.0",
                    "config": self.app.config.model_dump() if hasattr(self.app.config, 'model_dump') else {}
                }
    ...
    async def _cleanup_old_backups(self):
        ...
        try:
            ...
            for backup_file in backup_files:
                ...
                try:
                    date_str = backup_file.name.split('.')[0].split('_')[1] + backup_file.name.split('.')[0].split('_')[2]
            ...
            # Delete old backups
            all_backups_set = {(bf[0], bf[1]) for bf in daily_backups + weekly_backups + monthly_backups}
    ...
    async def restore_backup(self, backup_id: str) -> bool:
        ...
        try:
            # Verify checksum
            stored_checksum = await self._calculate_checksum(backup_path)
...
class DisasterRecoveryManager:
    ...
    async def run_disaster_recovery_check(self) -> Dict[str, Any]:
        ...
        results["checks"]["recent_backup"] = {
            ...
            "latest_backup_age_hours": latest_backup_age.total_seconds() / 3600 if backups else None
        }
    ...
    async def initiate_disaster_recovery(
        ...
        try:
            ...
            if success:
                ...
                return {
                    "status": "fail",
                    "error": f"Failed to restore from backup {backup_id}"
                }
