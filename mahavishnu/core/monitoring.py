...
class AlertManager:
    ...
    def _init_default_handlers(self):
        ...
        self.register_handler(AlertType.PERFORMANCE_DEGRADATION, self._handle_performance_degradation)
    ...
    async def send_notification(self, alert: Alert):
        ...
        try:
            message = {
                ...
                "attachments": [
                    {
                        "color": "danger" if alert.severity in [AlertSeverity.HIGH, AlertSeverity.CRITICAL] else "warning" if alert.severity == AlertSeverity.MEDIUM else "good",
                        "fields": [
                            {
                                "title": "Description",
