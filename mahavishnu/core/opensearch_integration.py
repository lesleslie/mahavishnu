...
class OpenSearchLogAnalytics:
        ...
        if OPENSEARCH_AVAILABLE:
            try:
                self.client = AsyncOpenSearch(
                    hosts=[config.opensearch_endpoint.replace('https://', '').replace('http://', '')],
    ...
    async def log_event(self, level: str, message: str, attributes: Dict[str, Any] = None, 
                       trace_id: str = None, workflow_id: str = None, repo_path: str = None, 
                       adapter: str = None):
    ...
    async def log_workflow_event(self, workflow_id: str, adapter: str, task_type: str, 
                                status: str, **kwargs):
    ...
    async def search_logs(self, query: str = None, level: str = None, 
                         workflow_id: str = None, repo_path: str = None,
        ...
        try:
            ...
            if query:
                search_body["query"]["bool"]["must"].append({"simple_query_string": {"query": query}})
    ...
    async def search_workflows(self, workflow_id: str = None, adapter: str = None, 
...
class OpenSearchIntegration:
    ...
    async def log_workflow_start(self, workflow_id: str, adapter: str, task_type: str, repos: List[str]):
    ...
    async def log_workflow_update(self, workflow_id: str, status: str, progress: int = None, **kwargs):
    ...
    async def log_workflow_completion(self, workflow_id: str, status: str, execution_time: float, 
                                     results_count: int, errors_count: int, **kwargs):
    ...
    async def log_error(self, workflow_id: str, error_msg: str, repo_path: str = None, adapter: str = None):
        """Log an error event."""
        await self.analytics.log_event(
            level="ERROR",
            message=error_msg,
