...
//
// Designed for the mahavishnu CI guard (test_mermaid_renders.py +
// the mahavishnu mermaid validator CLI). Uses mermaid.parse() — the lexer-only
...
//
// The Python wrapper (mahavishnu.tools.mermaid_validator.renderer) computes
// both absolute paths and passes them as argv[2] and argv[3]. Each path is
// loaded via dynamic `import()` because Node ESM does NOT honor NODE_PATH
// for static imports (v18+).
