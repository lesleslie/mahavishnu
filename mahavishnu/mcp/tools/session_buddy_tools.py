...
def register_session_buddy_tools(server, session_manager, mcp_client):
    ...
    async def index_code_graph(
        ...
        try:
            ...
            if not app:
                return {
                    "status": "error",
                    "error": "App instance not available in server context"
                }
            ...
            return {
                "status": "error",
                "error": f"Failed to index code graph: {str(e)}"
            }
    ...
    async def get_function_context(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to get function context: {str(e)}"
            }
    ...
    async def find_related_code(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to find related code: {str(e)}"
            }
    ...
    async def index_documentation(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to index documentation: {str(e)}"
            }
    ...
    async def send_project_message(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to send project message: {str(e)}"
            }
    ...
    async def list_project_messages(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to list project messages: {str(e)}"
            }
