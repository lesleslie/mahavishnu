...
from ...messaging.repository_messenger import MessageType, MessagePriority, RepositoryMessengerManager
...
def register_repository_messaging_tools(server, app, mcp_client):
    ...
    async def send_repository_message(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to send repository message: {str(e)}"
            }
    ...
    async def broadcast_repository_message(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to broadcast repository message: {str(e)}"
            }
    ...
    async def get_repository_messages(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to get repository messages: {str(e)}"
            }
    ...
    async def acknowledge_repository_message(
        ...
        """
        try:
            success = await messenger_manager.messenger.acknowledge_message(message_id, receiver_repo)
    ...
    async def notify_repository_changes(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to notify repository changes: {str(e)}"
            }
    ...
    async def notify_workflow_status(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to notify workflow status: {str(e)}"
            }
    ...
    async def send_quality_alert(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": f"Failed to send quality alert: {str(e)}"
            }
