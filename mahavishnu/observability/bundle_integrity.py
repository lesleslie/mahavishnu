...
from mahavishnu.observability.metrics import record_bundle_integrity_failure
...
def verify_sha256(
    ...
    *,
    ...
    Args:
        ...
        backend: Adapter kind label for the metric (``"local"``, ``"s3"``,
            ``"gcs"``, ``"azure"``). Must be one of the allowlist.
        principal: Optional principal name for the metric. Hashed to an
            8-char prefix before emission to bound OTel cardinality.
