"""Compatibility wrapper for the Agno adapter implementation.

.. deprecated:: 0.4.0
    This module is a re-export wrapper. Import directly from
    ``mahavishnu.engines.agno_adapter_impl`` instead.
...
warnings.warn(
    "mahavishnu.engines.agno_adapter is a compatibility wrapper. "
    "Import from mahavishnu.engines.agno_adapter_impl instead. "
    "This wrapper will be removed in a future release.",
    DeprecationWarning,
    stacklevel=2,
)

from . import agno_adapter_impl as _impl
from .agno_adapter_impl import *  # noqa: F401,F403,E402
