...
This module provides helper functions for integrating the WebSocket server
with the main Mahavishnu application and MCP server.
"""
...
async def start_websocket_server(
    ...
    """Start the WebSocket server for Mahavishnu.
    ...
    # For now, we'll enable it if the setting exists and is True
    ...
    try:
        ...
        # Start the server
        await server.start()
        logger.info(f"WebSocket server started on ws://127.0.0.1:8690")
