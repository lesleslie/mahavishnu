...
| **Dhara** | Optional | Configured | Persistent cloud storage |
...
- No direct Dhara MCP client found in codebase
...
- No hard dependency on Dhara (uses direct S3/R2)
