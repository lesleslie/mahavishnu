    ...
    "panels": [
      {
        ...
        "targets": [
          ...
          {
            "expr": "websocket_connections{server=\"dhara\"}"
          }
        ]
      },
      {
...
server {
    ...
    location /ws/dhara {
        proxy_pass http://dhara_websocket;
        proxy_http_version 1.1;
        proxy_set_header Upgrade $http_upgrade;
        proxy_set_header Connection $connection_upgrade;
    }
