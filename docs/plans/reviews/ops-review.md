...
2. Allocate Redis DB index or key prefix before any client wiring.
3. Add a one-paragraph "failure mode" section to the plan covering what happens when the gateway is down and how clients should react.
4. Ship a complete, tested plist with the implementation.
