...
| Cache policy defined | In progress | Codex | `config/bifrost/config.template.json` + Redis Stack on `6380` | 2026-04-08 | Dedicated Redis Stack cache backend is active; direct-cache smoke test passed, semantic mode still needs embedding strategy |
