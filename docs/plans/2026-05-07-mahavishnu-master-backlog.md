...
## **Created**: 2026-05-07 **Status**: `canonical` — single authoritative list of confirmed open work <!-- legacy status: canonical, Final Gate — see YAML frontmatter --> **Authority**: Verified against codebase 2026-05-07. Items here were confirmed missing by code inspection; closed/superseded items were removed. **Last updated**: 2026-05-08 — All priorities delivered; Final Gate complete.
