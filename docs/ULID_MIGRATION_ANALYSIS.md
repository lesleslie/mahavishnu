...
1. **Direct Dhara integration:** Uses the actual ULID library that powers the ecosystem
2. **Proper fallback:** If Oneiric unavailable, goes directly to Dhara (source of truth)
...
2. **Add unit tests** for ULID generation with Dhara fallback
