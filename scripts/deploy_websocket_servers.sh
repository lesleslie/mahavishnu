...
start_servers() {
    ...
    # Note: Dhara, Akosha, Crackerjack would be started via their own MCP servers
...
check_servers_health() {
    ...
    for service in "Dhara:8693" "Akosha:8692" "Crackerjack:8686" "Excalidraw:3042" "Fastblocks:8684"; do
